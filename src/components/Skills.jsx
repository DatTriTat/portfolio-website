...
const Skills = ({ styles, deviceType }) => {
  const skills = {
    ...
    "Frameworks & Libraries": ["Spring Boot", "Node.js", "Express.js", "Flask", "FastAPI", "React.js", "Blazor", "ASP.NET Boilerplate", "Next.js", "Java Swing"],
    "Technologies": ["Redis", "WebSocket", "RabbitMQ", "Kafka", "Kubernetes (GKE, EKS)", "Docker", "PostgreSQL", "MongoDB", "MongoDB Vector Search", "DynamoDB", "Firebase", "MSSQL", "AWS (S3, Lambda, EC2, Cognito)", "OpenAI API", "LangChain", "AssemblyAI", "GraphQL", "RESTful APIs", "Microservices", "Nginx"],
